...
var HIDE_VALIDATOR_STATUS = (process.env.HIDE_VALIDATOR_STATUS === 'false' ? false : true);
...
Node.prototype.getInfo = function()
{
	...
	try {
		if (web3.eth.mining && HIDE_VALIDATOR_STATUS === false) {
	...
	if (this._web3 && (lastFetchAgo >= UPDATE_INTERVAL || forced === true))
	{
		...
		function (err, results)
		{
			...
			if(results.peers !== null)
			{
				...
				self.stats.mining = (HIDE_VALIDATOR_STATUS === false ? results.mining : false);
